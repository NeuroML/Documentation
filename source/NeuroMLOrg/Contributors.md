...
It is generated periodically, most recently on 04/09/23. See also the current {ref}`NeuroML Editorial Board<neuromlorg:board>` and the {ref}`Scientific Committee <neuromlorg:ScientificCommittee>`.
