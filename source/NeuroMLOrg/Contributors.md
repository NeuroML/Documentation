...
It is generated periodically, most recently on 19/10/22. See also the current {ref}`NeuroML Editorial Board<neuromlorg:board>` and the {ref}`Scientific Committee <neuromlorg:ScientificCommittee>`.
