...
```
```{code-block} xml
<include xmlns:xi="http://www.w3.org/2001/XInclude" href="NML2_SimpleIonChannel.nml"/>
```
```{code-block} xml
<include href="NML2_SingleCompHHCell.nml"/>
```
...
```
```{code-block} xml
<cell xmlns:xi="http://www.w3.org/2001/XInclude" id="SpikingCell" metaid="HippoCA1Cell">
