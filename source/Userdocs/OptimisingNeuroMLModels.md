...
- it replaces the least fit models with the new individuals
...
- we list the target parameters that the optimiser will use to calculate fitness, and set their weights
