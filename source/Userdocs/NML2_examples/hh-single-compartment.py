...
def plot_data(sim_id):
    ...
    pynml.generate_plot([data_array[:, 0]], [data_array[:, 3], data_array[:, 4]], "current density", show_plot_already=False, save_figure_to=sim_id + "-iden.png", xaxis="time (s)", yaxis="current density (A_per_m2)")
