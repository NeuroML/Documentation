...
<div id="carousel-neuroml" class="carousel slide" data-bs-ride="carousel">
  <ol class="carousel-indicators">
    <li data-bs-target="#carousel-neuroml" data-bs-slide-to="0" class="active"></li>
    <li data-bs-target="#carousel-neuroml" data-bs-slide-to="1"></li>
    <li data-bs-target="#carousel-neuroml" data-bs-slide-to="2"></li>
    <li data-bs-target="#carousel-neuroml" data-bs-slide-to="3"></li>
    <li data-bs-target="#carousel-neuroml" data-bs-slide-to="4"></li>
  </ol>
...
<a class="carousel-control-prev" href="#carousel-neuroml" role="button" data-bs-slide="prev">
  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
  <span class="sr-only">Previous</span>
</a>
<a class="carousel-control-next" href="#carousel-neuroml" role="button" data-bs-slide="next">
